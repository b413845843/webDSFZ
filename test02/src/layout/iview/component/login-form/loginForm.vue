<template>
  <div>
      <transition name="slide-fade" mode="out-in">
        <Form v-if="isLogin" ref="loginForm" :model="user"  :rules="rules" key="1">
          <FormItem prop="name">
        ...
        <Form v-else ref="registerForm" :model="ruser" :rules="resigsterRules" key="2">
          ...
          <FormItem prop="password">
            <Input v-model="ruser.password" placeholder="密码" clearable>
              <span slot="prepend">
                <Icon :size="14" type="md-lock"></Icon>
              </span></Input>
          </FormItem>
          <FormItem  prop="passwordCheck">
            <Input v-model="ruser.passwordCheck" placeholder="确认密码" clearable>
              <span slot="prepend">
